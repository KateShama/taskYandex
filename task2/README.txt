Неоходимо клонировать репозиторий(так как на каком-то сервере не размещен) - git clone https://github.com/KateShama/taskYandex.git
Зайти в cmd в папку task2 (вписать cd taskYandex/task2)
далее запустить bot.py (python bot.py)
